        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-3">Original Price (₹)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-3">Discounted Price (₹)</label>
                <input
                  type="number"
